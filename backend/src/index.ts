...
import { createCorsOriginPolicy } from './utils/corsOriginPolicy.js';
import {
  authenticate,
  optionalAuth,
...
import voiceAccessRoutes from './routes/voiceAccess.js';
...
app.use('/api/calendar', documentsRateLimiter, calendarRoutes);
...
app.use('/api/voice-access', voiceAccessRoutes);
