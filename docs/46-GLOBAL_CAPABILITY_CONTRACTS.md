...
| Calendar                          | —                            |              4 |                   0 | `backend/src/types/index.ts`                                                                                 | N/A — Calendar events are first-party account resources and have no installable or discovery manifest.               | N/A — Calendar events have no implicit content default beyond explicit user-supplied fields; recurrence math uses the server timezone documented in docs/47-CALENDAR.md. | `docs/47-CALENDAR.md`                                        | `calendar events persist per owner and expand recurrence into range queries`<br />`scripts/test-calendar.mjs` (`test:package`)                                                                                                                                                                                                                                                                                                                                                                                                 |
