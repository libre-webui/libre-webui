...
| Channels                          | —                            |             24 |                   0 | `backend/src/types/index.ts`                                                                                 | N/A — Channels are first-party account resources and have no installable or discovery manifest.                                                                  | `docs/54-CHANNELS.md`                                                                                                                                                    | `docs/54-CHANNELS.md`                                                           | `timeline: idempotent posts, ordering, threads, edit and tombstone rules`<br />`scripts/test-channels.mjs` (`test:package`)<br />`@model mentions run under the invoking member and fail safely`<br />`scripts/test-channels.mjs` (`test:package`)                                                                                                                                                                                                                                                                                                                                                                                                                  |
