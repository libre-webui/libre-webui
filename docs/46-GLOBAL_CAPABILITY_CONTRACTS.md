...
| Model management                  | —                            |             51 |                   0 | `backend/src/types/index.ts`                                                                                 | `scripts/capability-contracts.json`                                                                                                                              | `backend/src/services/ollamaService.ts`                                                                                                                                  | `docs/02-WORKING_WITH_MODELS.md`                                                                 | `cloud library pulls append the Ollama cloud suffix automatically`<br />`frontend/e2e/model-manager.spec.ts` (`test:e2e`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Automations                       | `/automations`               |             15 |                   0 | `backend/src/types/index.ts`                                                                                 | N/A — Automations are first-party account resources and have no installable or discovery manifest.                                                               | `docs/48-AUTOMATIONS.md`                                                                                                                                                 | `docs/48-AUTOMATIONS.md`                                                                         | `the scheduler fires due automations once and settles stalled runs`<br />`scripts/test-automations.mjs` (`test:package`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| Work                              | `/work`<br />`/work/:taskId` |             44 |                   3 | `backend/src/types/work.ts`                                                                                  | `scripts/capability-contracts.json`                                                                                                                              | `backend/src/services/workRuntimeShared.ts`                                                                                                                              | `docs/33-WORKSPACES.md`                                                                          | `runtime limits expose admission capacity and live occupancy`<br />`scripts/test-work-runtime.mjs` (`test:package`)<br />`approval decisions gate side-effecting Work actions`<br />`scripts/test-work-approvals.mjs` (`test:package`)<br />`an agent delegates to a peer and the report returns to its conversation`<br />`scripts/test-work-delegation.mjs` (`test:package`)<br />`connected tools reach network-enabled runs and stay off offline ones`<br />`scripts/test-work-mcp.mjs` (`test:package`)<br />`production Work upgrade applies task-bound ticket authentication`<br />`scripts/test-websocket-tickets.mjs` (`test:package`)                                                                                                                                                                                                                        |
...
- `GET /api/ollama/settings` — `backend/src/routes/ollama.ts` (mount `/api/ollama`, subpath `/settings`)
...
- `PUT /api/ollama/settings` — `backend/src/routes/ollama.ts` (mount `/api/ollama`, subpath `/settings`)
...
- `POST /api/plugins/probe-endpoint` — `backend/src/routes/plugins.ts` (mount `/api/plugins`, subpath `/probe-endpoint`)
...
- `DELETE /api/automations/:automationId/webhook-secret` — `backend/src/routes/automations.ts` (mount `/api/automations`, subpath `/:automationId/webhook-secret`)
...
- `POST /api/automations/:automationId/webhook` — `backend/src/routes/automations.ts` (mount `/api/automations`, subpath `/:automationId/webhook`)
- `POST /api/automations/:automationId/webhook-secret` — `backend/src/routes/automations.ts` (mount `/api/automations`, subpath `/:automationId/webhook-secret`)
...
- `DELETE /api/work/tasks/:id/approval-rules/:ruleId` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/approval-rules/:ruleId`)
- `DELETE /api/work/tasks/:id/computer/control` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/control`)
...
- `GET /api/work/computer/setup` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/computer/setup`)
...
- `GET /api/work/tasks/:id/approvals` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/approvals`)
- `GET /api/work/tasks/:id/computer/control` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/control`)
...
- `POST /api/work/computer/setup` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/computer/setup`)
- `POST /api/work/computer/skills/:slug/trace` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/computer/skills/:slug/trace`)
...
- `POST /api/work/tasks/:id/approvals/:approvalId` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/approvals/:approvalId`)
- `POST /api/work/tasks/:id/cancel` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/cancel`)
- `POST /api/work/tasks/:id/computer/anchor` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/anchor`)
- `POST /api/work/tasks/:id/computer/control` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/control`)
- `POST /api/work/tasks/:id/computer/start` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/start`)
- `POST /api/work/tasks/:id/computer/teach` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/computer/teach`)
...
- `POST /api/work/tasks/:id/messages` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/messages`)
...
- `POST /api/work/tasks/:id/seen` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/seen`)
...
- `PUT /api/work/tasks/:id/approvals` — `backend/src/routes/work.ts` (mount `/api/work`, subpath `/tasks/:id/approvals`)
...
- `GET /api/preferences/default-theme` — `backend/src/routes/preferences.ts` (mount `/api/preferences`, subpath `/default-theme`)
...
- `PUT /api/preferences/default-theme` — `backend/src/routes/preferences.ts` (mount `/api/preferences`, subpath `/default-theme`)
...
- `WEBSOCKET /ws/work-audio` — **Work**, `backend/src/websocketServer.ts`; authentication evidence: `backend/src/workScreenServer.ts`
