...
3. **Who may use it** — the **Web search** card under Settings → User Management → Access & policies, next to
...
regular users need the **Web search** toggle under Settings → User Management → Access & policies turned on.
