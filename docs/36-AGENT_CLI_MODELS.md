...
turn it on under **Settings → User Management → Access & policies → Agents**. The setting is persisted and
...
**Settings → User Management → Access & policies → Agents** (it is off by default) and that you are signed in
