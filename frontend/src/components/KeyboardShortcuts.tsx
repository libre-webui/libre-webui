...
export const KeyboardShortcutsIndicator: React.FC<{
  ...
  return (
    <Button
      ...
      className={cn(
        'fixed bottom-4 end-4 h-10 w-10 p-0 bg-white/80 dark:bg-dark-100/80 backdrop-blur-sm border border-gray-200 dark:border-dark-300 shadow-lg hover:shadow-xl transition-all duration-200 z-50',
    ...
    >
      ...
      {isHovered && (
        <div className='absolute bottom-full mb-2 end-0 px-2 py-1 text-xs bg-gray-900 text-white rounded whitespace-nowrap'>
          {t('keyboard.tooltip')}
        </div>
      )}
    </Button>
