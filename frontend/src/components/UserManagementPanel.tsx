...
/**
 * Administrator controls: instance-wide access toggles, policies, groups,
 * the audit log, and the user list. Rendered inside Settings under the
 * Administration group; the old /users route opens that tab.
 */
