...
Status: phases 1–3 complete. The `WorkRuntimeDriver` seam exists
...
files/commands/git, policy-fingerprint annotations, label-driven
reconciliation, interactive terminals (exec-with-TTY WebSocket, resize
